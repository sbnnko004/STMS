...
<script
	src="https://jonthornton.github.io/jquery-timepicker/jquery.timepicker.js"></script>
	...
	<div class="wrapper">
		<div class="sidebar" data-image="./images/sideBarBackground.png">
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					<li class="active"><a href="#"> <i class="pe-7s-display1"></i>
							<p>Planner</p>
					</a></li>
					...
					<li><a> <i class="pe-7s-plus"></i>
							<p>Add Event</p>
					</a></li>
					<li><a data-toggle="collapse" data-target="#upComingEventList">
					...
					<li><a data-toggle="collapse" data-target="#missedEventList">
							<i class="pe-7s-date"></i>
							<p>Missed events</p>
					</a>
					...
					<li><a data-toggle="collapse" data-target="#currentEventList">
					...
					<li class="mobile-app"><a href="#"> <i class="pe-7s-phone"></i>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#" title="Application Settings">
									<p>
									...
									<div class="content">
										<div class="panel panel-login">
											<div class="panel-body">
												<div class="row">
													<div class="col-lg-12">
														<form id="login-form" action="addevent" method="post"
															...
															<div class="form-group col-lg-12">
																<div>
																	...
																	<select
																		id="type" name="type" form="login-form">
																...
																<div id="courseCode">
																	...
																	<select id="coursecode" name="coursecode" form="login-form">
																		...
																		<option value=<%= String.valueOf("\""+course+"\"") %>><%= String.valueOf(course) %></option>
																		<% } %>
																	</select>
															...
															<div id="endDate" class="form-group">
																<input type="text" name="enddate" id="enddate"
																	...
																	placeholder="End Date: YYYY-MM-DD" value="">
															</div>
															...
															<div id="endTime" class="form-group">
																<input type="text" name="endtime" id="endtime"
																	...
																	placeholder="End Time: HH:MM" value="">
															</div>
															<div id="Duration" class="form-group">
																<input type="number" name="duration" id="duration"
																	tabindex="6" class="form-control"
																	placeholder="Enter test duration in minutes" value="">
															</div>
																...
																<div class="row">
																	<div class="col-sm-6 col-sm-offset-3">
																		<input type="submit" name="event-submit"
																			id="event-submit" tabindex="7"
																			class="form-control btn btn-login" value="Add Event">
																	</div>
																</div>
															</div>
														</form>
